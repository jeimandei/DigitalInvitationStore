...
public class MediaProperties {
    ...
    public int getPresignPutExpiryMinutes() {
        return presignPutExpiryMinutes;
    }

    public void setPresignPutExpiryMinutes(int v) {
        this.presignPutExpiryMinutes = v;
    }

    public int getPresignGetExpiryHours() {
        return presignGetExpiryHours;
    }

    public void setPresignGetExpiryHours(int v) {
        this.presignGetExpiryHours = v;
    }
    ...
    public void setAllowedTypes(String v) {
        this.allowedTypes = v;
    }
